...
- Activate the color themes by selecting them from the Command Palette (`Cmd+Shift+P`) with `Preferences: Color Theme` and choosing either `dCBOR Envelope Dark` or `dCBOR Envelope Light`.
